...
internal record BasicItemStatsRequest(string ServerSlug, string UniqueName) : IRequest
{
    ...
    public Uri ToUri()
    {
        return new Uri(Constants.NexusHubApiUrlV1 + $"items/{ServerSlug}/{UniqueName}");
    }
}